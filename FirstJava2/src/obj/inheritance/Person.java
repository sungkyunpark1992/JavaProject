 ...
 *	 - 기존의 코드를 재사용 함으로 필요한 코드 재작성을 줄여줌 
 ...
 *	 - 생성자는 상속이 안됨.
 *	 - sub Class "is a" Super Class; is a는 "~에 속해 있다"는 의미
 ...
 *	
 *	  - Good Case
 *		-> 중복된 기능을 빼고(=일반화), 새로운 클래스로 작성한 후 구체화 시킨 경우
 *		-> 일반화 된 클래스는 부모 클래스
 *		-> 구체화 된 클래스는 자식 클래스
 *		-> extends 키워드를 사용하게 됨
 *	 
...
public class Person {
	...
	public boolean equals(Object obj) {
		...
		Person other = (Person)obj;	//부모는 자식을 포함할 수 있다. - 다형성 타입캐스팅형변환
