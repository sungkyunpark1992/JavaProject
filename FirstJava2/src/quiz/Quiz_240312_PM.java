...
//		}
		...
		//통신데이타는 유니코드가 아니라 아스키코드다 외워두는게 좋다.
		Scanner scan = new Scanner(System.in);
		System.out.println(">> ");
		...
		if (ch>='A' && ch<='Z') {
			ch = (char)(ch - 'A' + 'a');
//			ch = (char)(ch - 32); ch - 'A' + 'a'와 같다
		}else if(ch>='a' && ch<='z'){
			ch = (char)(ch - 'a' + 'A');
		}
		System.out.println(ch);
		
		//문자열을 대문자 문자열 변경	Srtring.toUpperCase()
		//문자열을 소문자 문자열 변경	Srtring.toLowerCase()
