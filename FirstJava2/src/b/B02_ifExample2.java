...
public class B02_ifExample2 {
	...
	public static void main(String[] args) {
		...
		//2. random을 임포트 : import를 사용하여 라이브러리에 있는 random클래스를 로드
		// randeom은 각 타입별로 난수를 발생시키는 메서드가 존재함.
		...
		//if ~ else문 : if 조건문이 true이면 if에 종속 실행문을 그렇지 않으면 else의 실행문을 동작!
		//정수 난수 발생( 0 ~ 99 )
		...
		if(jumsu>=60) {
			...
			System.out.println("60미만인 점수입니다.");
