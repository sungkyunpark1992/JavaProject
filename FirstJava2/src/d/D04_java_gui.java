 ...
 *   - Frame 또는 JFrame 클래스를 이용해 프레임 창을 구현. 프레임창 구현 후에 각종 이벤트 처리 및
 *    버튼, 패널, 입력창, 메뉴바, 속성 같은 구성요소들을 각 클래스들을 이용해서 구현.
 * 
 * 	 - Frame(A)클래스가 각종 구성요소(B) 클래스들을 전부 호출. 구성요소(B)클래스 들은 각 프레임창별로 달라지기 때문에 
