...
public class D15_stringEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(str);	//str에는 변화가 없다.
		
		System.out.println(str.substring(0,5)); //5번 인덱스 포함x
		...
		// 3. indexOf : 원하는 문자의 인덱스를 반환(못찾는 경우 -1로 표기)
		...
		String orange = str.substring(str.indexOf("orange"),
