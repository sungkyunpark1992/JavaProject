...
interface ShapeInterface{
	...
	//인터페이스 메서드는 추상 메서드로 public abstract를 생략할 수 있다
	public abstract double getArea();	// 추상 메서드
	// double getArea();				// 위와 같음
}

class RactangleI implements ShapeInterface{
	int width;
	int height;
...
public class D01_interfaceEx1 {
	...
	public static void main(String[] args) {
		//test
		RactangleI ractangleI = new RactangleI(20, 34);
		TriangleI triangleI = new TriangleI(20,34);
		
		ShapeInterface s1 = new RactangleI(30,48);	// 다형성
		
		System.out.println("rect's Area = "+ractangleI.getArea());
